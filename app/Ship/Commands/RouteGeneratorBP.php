...
/**
 * Class RouteGeneratorBP
 *
 * @author  Mahmoud Zalt  <mahmoud@zalt.me>
 */
class RouteGeneratorBP extends GeneratorCommand implements ComponentsGenerator
{
     ...
     * @var string
     */
    protected $name = 'apiato:generate:bproute';
     ...
     * @var string
     */
    protected $description = 'Create a new Backpack related Route class';
     ...
     * @var  string
     */
    protected $stubName = 'routes/custom.stub';
    ...
    public function getUserInputs()
    {
        ...
        $url = Str::lower($this->checkParameterOrAsk('url', 'Enter the endpoint URI (phú bà/{id})'));
        $url = ltrim($url, '/');
